...
`
当前基于计算机视觉的医疗影像AI辅助诊断是人工智能在医疗领域中最为成熟的应用之一，可为医生提供具体的诊断参考意见。北京市丰台区方庄社区卫生服务中心引入**人工智能**辅助决策支持系统，提供诊前、诊中全流程决策支持，促进优质医疗资源**智能化下沉**，有效解决基层诊疗能力、专科能力不足等问题，为家庭医生签约服务赋能增效。
...
江西卫健委分享<村村通>的实施细节：使用AI科技帮助**基层医生**的工作
