...
-- 合规安全：每篇都通过基金会严格（反复）审查，审查范围包含：错别字、禁忌字词、守网络安全法规、不涉医事药物推广、不涉敏感话题、不推荐营养补充、不出现品牌。11年以来，每篇出刊都经过基金会二人以上的审查。

**宝贵的资产**
AI时代来临，这些资产特别宝贵。可被用于建立语言模型库。


## 新科技 1：LLM 语言模型 ##
LLM（大语言模型）善于叙事，能够陈述各种内容，如果加以训练，可以陈述专项内容（被称为专家LLM）。

## 新科技 2： Vi （vision）图像识别 ##
能够正确识别众多生活物件与场景，准确度高，效率快。

## Vi-LLM ##
LLM与Vi结合是一个新的技术领域，未来的应用前景广泛。
