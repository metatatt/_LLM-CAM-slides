...
![image](https://github.com/metatatt/_LLM-CAM-slides/assets/100538673/573315ad-455e-45ce-9b1f-bcc8b58bd8f5)
...
```
卫健委（数字健康）2023年典型案例：新一代信息技术（人工智能、5G）在临床辅助决策支持、公共卫生服务、教学与科研、健康管理等方面的案例。

```


案例名单：http://www.nhc.gov.cn/mohwsbwstjxxzx/s8553/202309/ec2a4bd6437a4813a330c17c06973d9b/files/6c6369c85b6e45af8794b7de4d34ddc6.pdf （国家卫健委【数字健康典型案例】2023年5月）



```
（家庭医生项目）北京市丰台区方庄社区卫生服务中心：智能化基层医疗支持
```

**人工智能**辅助决策支持系统，提供诊前、诊中全流程决策支持，促进优质医疗资源**智能化下沉**，有效解决基层诊疗能力、专科能力不足等问题，为家庭医生签约服务赋能增效。（国家发改委。2023年7月，专家意见）



```
（AI病历）江西卫健委<村村通>：辅助病历书写
```
...
```
（老龄守护）：利用人工智能技术加速推进<老龄守护>（2022年两会议案）
```
